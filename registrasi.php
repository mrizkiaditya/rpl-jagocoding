...
<html lang="en">
    <head>
        ...
        <title>Register - jagocoding</title>
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input name="password2" class="form-control" id="password2" type="password" placeholder="Confirm your password" />
                                                        <label for="password2">Confirm Password</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-4 mb-0">
                                                <button type="submit" name="register" class="btn btn-primary btn-block" class="d-grid"><a id="sign">Create Account</a></button>
                                            </div>
