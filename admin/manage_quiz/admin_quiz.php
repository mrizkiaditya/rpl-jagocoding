...
$tbl_soal = "SELECT * FROM tbl_soal WHERE programming_name = '$programming_name'";
$result = mysqli_query($conn, $tbl_soal);
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Quiz <?= $programming_name; ?></h1>

                        <button name="submit" class="btn btn-primary" type="submit"><a style="text-decoration: none; color: white;" href="tambah_quiz.php">Add New Quiz</a></button>
