                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="topic" id="topic" class="form-control" value="<?= $courses["topic"] ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="description" class="form-label">Description</label>
                                        <textarea name="description" id="description" class="ckeditor"><?= $courses["description"] ?></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="programming_name" class="form-label">Programming Language</label>
                                        <input type="text" name="programming_name" id="programming_name" class="form-control" value="<?= $courses["programming_name"] ?>">
                                    </div>
