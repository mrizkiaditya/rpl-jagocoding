...
if(isset($_POST['submit'])){
    ...
    for ($i=0;$i<$jumlah;$i++){
        ...
        if (empty($pilihan[$nomor])){
            ...
            $query=mysqli_query($conn, "SELECT * from tbl_soal where id='$nomor' and knc_jawaban='$jawaban'");
...
$total_ques=$benar+$salah;
$percentage=($benar*100)/$total_ques;
$message="";
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="courses.html" class="get-started-btn">LOG OUT</a>
 ...
 <div class="card-header mt-5 bg-danger text-light">
  ...
  <button type="button" class="btn btn-primary mt-3"><a href="quiz_main.php" style="text-decoration: none; color: white;">Back</a></button>
